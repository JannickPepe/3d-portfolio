                    ...
                    <div className="-mx-4 flex flex-wrap justify-between">
                        ...
                        <div className="px-4 my-4 w-full sm:w-auto xl:w-1/5">
                            ...
                            <div className='flex justify-start items-center gap-2'>
                                <a href="#" className="inline-flex items-center justify-center h-10 w-10 border border-[#5D12D2] rounded-full mr-1 hover:text-blue-400 hover:border-[#915EFF]">
                                ...
                                <a href="#" className="inline-flex items-center justify-center h-10 w-10 border border-[#5D12D2] rounded-full mr-1 hover:text-blue-400 hover:border-[#915EFF]">
                                    <svg className="w-6 h-6 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
                                ...
                                <a href="#" className="inline-flex items-center justify-center h-10 w-10 border border-[#5D12D2] rounded-full hover:text-blue-400 hover:border-[#915EFF]">
